...
A curated list of data sources, portals, and references useful for building,
verifying, and extending the `sopo-setbacks` overlay.
...
- **Parcels with zoning attributes** — Published on the ArcGIS Hub as a downloadable feature service. Export as GeoJSON or query the FeatureServer REST endpoint directly.
  - FeatureServer: `https://services5.arcgis.com/OpN4013XQ19WlWn4/arcgis/rest/services/Parcels_for_download/FeatureServer/0`
  - Hub download: <https://city-of-south-portland-southportland.hub.arcgis.com/maps/c59a1b15c87a4628ac1e6dca7ece110c>
- **Street centerlines** — Available from the ArcGIS Hub or Maine GeoLibrary. Used by `sopo_setbacks.py` to classify parcel edges as front / side / rear.
  - FeatureServer: `https://services5.arcgis.com/OpN4013XQ19WlWn4/arcgis/rest/services/Roads/FeatureServer/0`
